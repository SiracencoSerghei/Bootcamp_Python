...
class InstaFollower:
    ...
    def find_followers(self):
        ...
        followers_xpath = '//*[@id="mount_0_0_P+"]/div/div/div[2]/div/div/div[1]/div[2]/div/div[2]/section/main/div/header/section[3]/ul/li[2]/div/a'
        followers_modal = self.driver.find_element(By.XPATH, value=followers_xpath)
        time.sleep(2.1)
        followers_modal.click()
        time.sleep(2.1)
