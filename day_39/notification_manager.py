...
class NotificationManager:
    ...
    def __init__(self):
        self.client = Client(os.environ['account_sid'], os.environ["TWILIO_TOKEN"])
    ...
    def send_whatsapp(self, message_body):
        message = self.client.messages.create(
            from_=f'whatsapp:{os.environ["from_whatsapp_number"]}',
            body=message_body,
            to=f'whatsapp:{os.environ["my_tel_number"]}'
        )
        print(message.sid)
